...
public class ZipParseActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zip_parse_view);
        
        Intent intent = getIntent();
        if (intent.getData() != null) {
    		getFolderPathEditText().setText(intent.getDataString());
        }else
        {
        ...
        browseButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
		        Intent intent = new Intent(ZipParseActivity.this, ZipPickerActivity.class);
    ...
    class ZipReadTask extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... arg0) {
	        ...
	        ed.putString(ZipKifuBrowserActivity.LAST_ZIP_PATH_KEY, zipPath);
	        ed.commit();
